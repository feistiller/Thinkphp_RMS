    ...
    <div class="template-page-wrapper">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            <li class="active"><a href="<?php echo U(GROUP_NAME.'/All/index');?>">注册企业管理</a></li>
            <li><a href="<?php echo U(GROUP_NAME.'/Detailed/index');?>">企业详细信息</a></li>
          </ol>
          ...
          <div>
                ...
                <div class="panel panel-primary">
                  <div class="panel-body">
                  <?php if(is_array($detailed)): foreach($detailed as $key=>$v): ?><table class="table table-striped">
                      <tbody>
                        <tr>
                          <td>企业ID</td>
                          <td><?php echo ($v["id"]); ?></td>
                        ...
                        <tr>
                          <td>企业规模</td>
                          <td><?php echo ($v["cnature"]); ?></td>
                        </tr>
                        <tr>
                          <td>所属行业</td>
                          <td><?php echo ($v["cindustry"]); ?></td>
                        </tr>
                      </tbody>
                  ...
                  <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>级别组说明</td>
                          <td>0级别指未通过审核组，1级正常组，2级招聘会参与组，3级确认到会组，4级未填写反馈表组</td>
                        </tr>
