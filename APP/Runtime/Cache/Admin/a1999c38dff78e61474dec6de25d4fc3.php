...
<body>
  <div class="navbar navbar-inverse" role="navigation">
    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li  class="active"><a href="<?php echo U(GROUP_NAME.'/Alljob/index');?>" ><i class="fa fa-sign-out"></i>查看招聘会</a></li>
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            <li><a href="<?php echo U(GROUP_NAME.'/Alljob/index');?>">查看招聘会列表</a></li>
            <li class="active"><a href="#">查看参加企业</a></li>
          </ol>
	...
	<?php if(is_array($company)): foreach($company as $key=>$v): ?><tr>
        ...
        <td><?php echo ($v["user"]["cname"]); ?></td>
        <td><?php echo ($v["people1"]); ?></td>
        <td><?php echo ($v["phone1"]); ?></td>
        <td><?php echo ($v["people2"]); ?></td>
        <td><?php echo ($v["phone2"]); ?></td>
        <td><?php echo ($v["email"]); ?></td>
        <td><?php echo ($v["user"]["class"]); ?></td>
        <td>
        	[<a href="">招聘会简章下载</a>]
        	[<a href="<?php echo U(GROUP_NAME.'/Alljob/del',array('id'=>$v['id']));?>">删除此企业</a>]
            [<a href="<?php echo U(GROUP_NAME.'/Detailed/index',array('id'=>$v['uid']));?>">查看企业详情</a>]
        </td>
        <td>
            <a href="<?php echo U(GROUP_NAME.'/Alljob/okget',array('id'=>$v['uid']));?>" class="btn btn-sm btn-info">企业已到会</a>
            <a href="<?php echo U(GROUP_NAME.'/Alljob/notget',array('id'=>$v['uid']));?>" class="btn btn-sm btn-danger">企业未到会</a>
        </td>
