...
<body>
  <div class="navbar navbar-inverse" role="navigation">
    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li  class="active"><a href="<?php echo U(GROUP_NAME.'/Return/index');?>" ><i class="fa fa-sign-out"></i>查看企业反馈</a></li>
   ...
   <table class="table table-bordered table-hover definewidth m10">
	...
	<?php if(is_array($return)): foreach($return as $key=>$v): ?><tr>
    	
        <td><?php echo ($v["username"]); ?></td>
        <td><?php if(($v["ornot"] == 0)): ?>满意
 		<?php elseif($v["ornot"] == 1): ?>不满意<?php endif; ?></td>
        <td><?php echo ($v["getnum"]); ?></td>
        <td><?php echo ($v["neednum"]); ?></td>
        <td><?php echo ($v["suggest"]); ?></td>
        
        <td>
        	[<a href="<?php echo U(GROUP_NAME.'/Return/del');?>">删除</a>]
