...
<body>
  <div class="navbar navbar-inverse" role="navigation">
    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li  class="active"><a href="<?php echo U(GROUP_NAME.'/Apply/index');?>"><i class="fa fa-map-marker"></i><span class="badge pull-right"></span>查看招聘会申请</a></li>
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            <li class="active"><a href="<?php echo U(GROUP_NAME.'/All/index');?>">企业招聘会申请</a></li>
          </ol>
	...
	<?php if(is_array($ajob)): foreach($ajob as $key=>$v): ?><tr>
    	<td><?php echo ($v["id"]); ?></td>
        <td><?php echo ($v["user"]); ?></td>
        <td><?php echo ($v["time"]); ?></td>
        <td><?php echo ($v["over"]); ?></td>
        <td>
        	[<a href="<?php echo U(GROUP_NAME.'/Apply/del',array('id'=>$v['id']));?>">删除此条信息</a>]
            [<a href="<?php echo U(GROUP_NAME.'/Detailed/index',array('id'=>$v['uid']));?>">查看企业详情</a>]
            [<a href="<?php echo U(GROUP_NAME.'/New/index');?>">发起新的招聘会</a>]
        </td>
