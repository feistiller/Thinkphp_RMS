...
<body>
  <div class="navbar navbar-inverse" role="navigation">
    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li  class="active"><a href="<?php echo U(GROUP_NAME.'/Meet/index');?>"><i class="fa fa-users"></i><span class="badge pull-right"></span>查看宣讲会申请</a></li>
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            <li class="active"><a href="<?php echo U(GROUP_NAME.'/Meet/index');?>">查看宣讲会申请</a></li>
          </ol>
	...
	<?php if(is_array($meet)): foreach($meet as $key=>$v): ?><tr>
    	<td><?php echo ($v["id"]); ?></td>
        <td><?php echo ($v["user"]); ?></td>
        <td><?php echo ($v["time"]); ?></td>
        <td><?php echo ($v["atime"]); ?></td>
        <td>
        	[<a href="<?php echo U(GROUP_NAME.'/Meet/del',array('id'=>$v['id']));?>">删除此条信息</a>]
