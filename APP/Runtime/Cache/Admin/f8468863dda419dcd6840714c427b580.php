...
<body>
  <div class="navbar navbar-inverse" role="navigation">
    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li  class="active"><a href="<?php echo U(GROUP_NAME.'/Web/index');?>"><i class="fa fa-cog"></i>查看资料发布申请</a></li>
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            <li class="active"><a href="<?php echo U(GROUP_NAME.'/Web/index');?>">查看资料发布申请</a></li>
	...
	<?php if(is_array($aweb)): foreach($aweb as $key=>$v): ?><tr>
    	<td><?php echo ($v["id"]); ?></td>
        <td><?php echo ($v["user"]); ?></td>
        <td><?php echo ($v["time"]); ?></td>
        <td><?php echo ($v["worker"]); ?></td>
        <td><?php echo ($v["num"]); ?></td>
        <td><?php echo ($v["phone"]); ?></td>
        <td><?php echo ($v["email"]); ?></td>
        <td>
        	[<a href="<?php echo U(GROUP_NAME.'/Web/del',array('id'=>$v['id']));?>">删除此条信息</a>]
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <a href="../Aweb/sign-in.html" class="btn btn-primary">Yes</a>
