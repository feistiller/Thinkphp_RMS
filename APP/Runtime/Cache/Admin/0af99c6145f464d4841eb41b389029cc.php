    ...
    <div class="templatemo-content-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li  class="active"><a href="<?php echo U(GROUP_NAME.'/User/index');?>" ><i class="fa fa-sign-out"></i>创建新的账号</a></li>
        </ul>
      </div><!--/.navbar-collapse -->
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            <li class="active"><a href="<?php echo U(GROUP_NAME.'/User/index');?>">新管理员注册</a></li>
            
          </ol>
          <table class="table table-bordered table-hover definewidth m10">
          <form action="<?php echo U(GROUP_NAME.'/User/add');?>" method="post" class="form-signin">
          	请输入用户名(请不要使用中文)：<input type="text" name="username" class="form-control"/><br>
			请输入密码：<input type="password" name="password" class="form-control"/><br>
			<input type="submit" value="创建新用户" class="btn btn-lg btn-primary btn-block"/>
          </form>
          </table>
